...
Given the decision to use microservices architecture, each bounded context will be implemented as a separate service:
...
foundation for architecture and detailed design phases.
