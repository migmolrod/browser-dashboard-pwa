...
This section covers the functional requirements of the system following the BDD methodology. We organize requirements
and BDD artifacts by Domain-Driven Design (DDD) bounded contexts defined in the domain documentation (DMD).
...
Each feature will have this pattern FR-XXX-00. These are the rules for each segment of the code:
...
- -000 suffix, with 000 being a three-digit number that identifies the feature.
