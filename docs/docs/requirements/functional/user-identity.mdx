...
##### Scenario 7: Login attempt during the lockout period
...
##### Scenario 8: Login after the lockout period expires
...
- US-UID-003-003: Logout and terminate the session
- US-UID-003-004: Session expires after inactivity

### Scenarios

##### Scenario 1: Create a session on login ("happy path")
...
##### Scenario 5: Logout and terminate the session
...
- US-UID-006-001: Delete an account successfully
- US-UID-006-002: Reject deletion with an incorrect password
- US-UID-006-003: Cancel account deletion
- US-UID-006-004: Cannot log in after deletion

### Scenarios

##### Scenario 1: Delete an account successfully ("happy path")
...
##### Scenario 2: Reject deletion with an incorrect password
