...
##### Scenario 2: Create an event with an invalid time range
...
##### Scenario 6: Create an event without a title
...
##### Scenario 3: View the calendar in the day view
...
##### Scenario 4: View the calendar in the agenda view
...
- US-CAL-003-001: Create a daily recurring event
- US-CAL-003-002: Create a weekly recurring event
- US-CAL-003-003: Edit a single instance of a recurring event
- US-CAL-003-004: Delete entire recurring series

### Scenarios

##### Scenario 1: Create a weekly recurring event ("happy path")
...
##### Scenario 2: Create a monthly recurring event
...
##### Scenario 3: Edit a single instance of a recurring event
...
##### Scenario 4: Edit the entire recurring series
...
##### Scenario 7: Create a recurring event with a custom pattern
...
- US-CAL-004-001: Set a reminder for an event
- US-CAL-004-002: Receive reminder notification
- US-CAL-004-003: Snooze a reminder
- US-CAL-004-004: Remove a reminder

### Scenarios

##### Scenario 1: Set a reminder for an event ("happy path")
...
##### Scenario 3: Click notification to view the event
...
##### Scenario 2: Create a category with a duplicate name
...
##### Scenario 3: Assign a category to an event
...
- US-CAL-006-001: Detect conflict when creating an event
- US-CAL-006-002: View conflicting events
- US-CAL-006-003: Override conflict warning

### Scenarios

##### Scenario 1: Detect conflict when creating an event ("happy path")
...
- US-CAL-007-001: Create an event from a task with a due date
- US-CAL-007-002: Create an event from a task without a due date
...
##### Scenario 4: Create an event with a task description
...
- US-CAL-008-001: Import events from an iCal file
- US-CAL-008-002: Export events to iCal file
- US-CAL-008-003: Handle duplicate events on import

### Scenarios

##### Scenario 1: Import events from an iCal file ("happy path")
...
- US-CAL-009-001: Create a single-day all-day event
- US-CAL-009-002: Create a multi-day all-day event
- US-CAL-009-003: Convert timed event to all-day
- US-CAL-009-004: Convert all-day event to timed

### Scenarios

##### Scenario 1: Create a single-day all-day event ("happy path")
...
##### Scenario 2: Create a multi-day all-day event
...
##### Scenario 3: All-day event displays at the top of day view
