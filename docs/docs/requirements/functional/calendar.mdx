...
|--------------|-------------------------------|-------------|--------|
| FR-CAL-001   | Event management              | Must Have   | Draft  |
| FR-CAL-002   | Calendar views                | Must Have   | Draft  |
| FR-CAL-003   | Recurring events              | Should Have | Draft  |
| FR-CAL-004   | Event reminders               | Should Have | Draft  |
| FR-CAL-005   | Event categories              | Should Have | Draft  |
| FR-CAL-006   | Event time conflict detection | Should Have | Draft  |
| FR-CAL-007   | Task integration              | Should Have | Draft  |
| FR-CAL-008   | Event import/export           | Could Have  | Draft  |
| FR-CAL-009   | All-day events                | Must Have   | Draft  |
