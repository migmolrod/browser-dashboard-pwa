...
##### Scenario 1: Create a new bookmark ("happy path")
...
##### Scenario 2: Create a bookmark with invalid URL
...
##### Scenario 6: Create a bookmark without a title
...
##### Scenario 4: Drop bookmark on an invalid target
...
##### Scenario 1: Import bookmarks from an HTML file ("happy path")
