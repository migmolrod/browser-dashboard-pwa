...
- US-DAS-001-001: Create the default dashboard on registration
...
- US-DAS-002-001: Add a widget to the dashboard
- US-DAS-002-002: Remove a widget from the dashboard
...
##### Scenario 5: Reorder widgets on a touch device
...
##### Scenario 3: Create a profile with a duplicate name
